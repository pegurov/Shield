...
#import "OldShieldViewController.h"
...
@interface OldShieldViewController () <BTManagerDelegate>
...
@implementation OldShieldViewController
...
- (void)updateLabels
{
    ...
    NSString *temperatureString = [BTManager sharedInstance].connectedShield.temperature? [NSString stringWithFormat:@"temperature: %@°", [BTManager sharedInstance].connectedShield.temperature] : @"";
    [self.labelTemperature setText:temperatureString];
